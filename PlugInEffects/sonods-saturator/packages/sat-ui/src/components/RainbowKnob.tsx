    ...
    >
      ...
      >
        ...
        >
          ...
          <circle
            ...
            style={{
              ...
              filter: isDragging ? 'drop-shadow(0 0 6px rgba(234, 179, 8, 0.5))' : 'none',
            }}
          />
        </svg>
        ...
        <div
          style={{
            ...
            height: size - 18,
            borderRadius: '50%',
            background: 'linear-gradient(145deg, #1e242f, #11141a)',
            boxShadow: '0 4px 12px rgba(0,0,0,0.6), inset 0 1px 2px rgba(255,255,255,0.15)',
        ...
        >
          ...
          <div
            style={{
              ...
              height: size - 30,
              borderRadius: '50%',
              background: 'radial-gradient(circle, #252d3a 0%, #15181f 100%)',
      ...
      <span
        style={{
          ...
          color: isDragging ? '#ffffff' : 'var(--sat-text-muted)',
